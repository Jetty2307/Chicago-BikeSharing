...
ending = '-tripdata.csv'
sql_path = '/Users/victor/airflow/dags/templates/union_all.sql'
...
def generate_union_sql():
    ...
    union_sql += "\nUNION ALL\n".join(
        [f'SELECT '
         ...
         f'start_station_name::TEXT, '
         f'start_station_id::TEXT, '  
         f'end_station_name::TEXT, '
         f'end_station_id::TEXT, ' 
         f'start_lat::DOUBLE PRECISION, '
         f'start_lng::DOUBLE PRECISION, '
         f'end_lat::DOUBLE PRECISION, '
         f'end_lng::DOUBLE PRECISION, '
         f'member_casual::TEXT '
