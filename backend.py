...
'''def forecast_rides_xgboost(request: ForecastRequest):
    ...
    forecast_1_xgboost = timeframe.make_prediction(steps=request.steps,
                                                    interval=request.interval, grid=fulldata_xgboost, rideable_type=1)
    forecast_2_xgboost = timeframe.make_prediction(steps=request.steps,
...
'''def forecast_rides_gam(request: ForecastRequest):
    ...
    forecast_2_GAM = timeframe.make_prediction(steps=request.steps,
